...
train_recommender_kfold(kfold=5, regularizer=0.01, learning_rate=0.008, num_factors=5, iterations=10, clipping=5, min_num_ratings=1, momentum=0.4, read_from_file=True)
